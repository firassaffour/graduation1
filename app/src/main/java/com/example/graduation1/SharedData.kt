...
val user = User("2", "Feras", "", ferasImage, "feras@gmail.com", "", "Android Developer", "Syria", emptyList(), groupsList = listOf("1", "3", "4"), gender = "Male", birthday =  "June, 04, 2004", isOnline =  true)
...
val friendsList = listOf(
    User("1", "Sara", "", saraImage, "sara@gmail.com", "", "UI/UX", "Egypt",  groupsList = listOf("2","3"), gender =  "Female", birthday = "June, 17, 2004"),
    User("2", "Feras", "", ferasImage, "feras@gmail.com", "", "Android Developer", "Syria",  groupsList = listOf("1","3","4"), gender = "Male", birthday ="June, 4, 2004", isOnline = true),
    User("3", "Mahmod", "", mahmodImage, "mohammed@gmail.com", "", "Backend Engineer", "Egypt", groupsList = listOf("2","1"), gender =  "Male", birthday =  "June, 17, 2004"),
    User("4", "Ahmed", "", ahmedImage, "ahmed@gmail.com", "", "Backend Engineer", "Egypt", groupsList = listOf("5","3"), gender =  "Male", birthday =  "June, 17, 2004"),
    User("5", "Omer", "", omerImage, "omer@gmail.com", "", "AI Trainer", "Egypt", groupsList = listOf("2","1","5"), gender =  "Male", birthday =  "June, 17, 2004"),
    User("6", "Seif", "", seifImage, "seif@gmail.com", "", "Backend Engineer", "Egypt", groupsList = listOf("2","3","4"), gender =  "Male", birthday =  "June, 17, 2004"),
)
...
var postList = listOf(
    PostData("1","3","2", "this is where every java developer started \uD83D\uDE02", codeSnippet = codeSnippet, likesCount = 1, commentsList = commentsList, createdAt = 1780345172462),
    PostData("2","5","6",  "AI is changing the world and every programmer on this earth want to learn about it, here you will find all you need and want", likesCount = 1, commentsList = commentsList, createdAt = 1779911111111),
    PostData("3","2","1",  "one of the biggest UI/UX community in the whole programming world", uiImage, likesCount = 1, commentsList = commentsList, createdAt = 1771111111111),
    PostData("4","4","4",  "can anyone fix this code ? ", codeSnippet = codeSnippet1, likesCount = 1, commentsList = commentsList, createdAt = 1761111111111),
    PostData("5","3","2", "i advice new developers to learn java before kotlin so they understand how old programming languages works", likesCount = 1, commentsList = commentsList, createdAt = 1761111111111)
)

val groupsList = listOf(
    Group("1", "5", "AI", aiImage),
    Group("2", "1", "UX meet up", uiImage),
    Group("3", "2", "Java",  javaImage),
    Group("4", "4", "Backend", backendImage),
    Group("5", "6", "AI", aiImage)
)
