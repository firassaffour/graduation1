...
fun SignUpScreen(navController: NavHostController, authViewModel: AuthViewModel){
    ...
    val annotatedText = buildAnnotatedString {
        withStyle(
            ...
            append("By continuing, you agree to our User")
        }
        ...
        Column(modifier = Modifier
            ...
            Surface(
                ...
                Row(
                    ...
                    if (googleButtonClicked) {
                        ...
                        Text(
                            if (googleButtonClicked) ""
                            else stringResource(R.string.Continue_google),
                            color = MaterialTheme.colorScheme.onBackground,
                            maxLines = 1,
                            fontWeight = FontWeight.Bold,
                            fontSize = 18.sp
            ...
            Surface(
                onClick = { facebookButtonClicked = !facebookButtonClicked },
                color = MaterialTheme.colorScheme.background,
                shape = RoundedCornerShape(16.dp),
                border = BorderStroke(width = 1.dp, color = MaterialTheme.colorScheme.onBackground)
            ) {
                Row(
                    ...
                    if (facebookButtonClicked) {
                        ...
                        Text(
                            if (facebookButtonClicked) ""
                            else stringResource(R.string.Continue_facebook),
                            color = MaterialTheme.colorScheme.onBackground,
                            maxLines = 1,
                            fontWeight = FontWeight.Bold,
                            fontSize = 18.sp
